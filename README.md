...
The staging file is then used to generate the data visualization. PDS DASH is also used as a tool for automating the creation of the data visualizations. 
